															...
															for(var d;a.length&&(d=a.shift());)a.length||void 0===b?c=c[d]&&c[d]!==Object.prototype[d]?c[d]:c[d]={}:c[d]=b},ha=function(a)
																{
																	...
																	{
																		for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])},Ge=function(a)
																			{
																				for(var b in a)
																					if(a.hasOwnProperty(b))
																						return!0;
																					return!1
																				},ye=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,Ie=window,He=document,Be=function(a,
b)
																				{
																					He.addEventListener?He.addEventListener(a,b,!1):He.attachEvent&&He.attachEvent("on"+a,b)},Ce=/:[0-9]+$/,xe=function(a,b)
																					{
																						var c=function(a)
																						{
																							...
																							switch(b)
																							{
																								...
																								break;
																								case "path":a="/"==a.pathname.substr(0,1)?a.pathname:"/"+a.pathname;a=a.split("/");0<=ha(a[a.length-1])&&(a[a.length-1]="");a=a.join("/");
																								break;
																														...
																														if(!(b=Le))
																															{
																																b=Array(256);
																																for(var c=0;256>c;c++)
																																	{for(var d=c,e=0;8>e;e++)d=d&1?d>>>1^3988292384:d>>>1;b[c]=d
																																	}
																																}
																																Le=b;
																																b=4294967295;
																																...
																																},Pe=function(a,b,c)
																																{
																																	...
																																	Ie.history&&Ie.history.replaceState&&(ze.test(b)||ze.test(c))&&(a=xe(a,"path"),b=e(b,"?"),c=e(c,"#"),Ie.history.replaceState({},void 0,""+a+b+c))},Re=function(a)
																																	{
																																		var b=void 0===b?3:b;try{if(a)
																																			{
																																				var c=Nd.exec(a);
																																				if(c&&"1"===c[1])
																																					{
