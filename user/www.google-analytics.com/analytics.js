						...
						function c(a,b)
						{
							...
							for(var c=0;c<a.length;c++)
								...
								function d(a)
								{
									...
									if(b)
										{
											var c=b[2],d=b[4];a=b[1];d&&(a=a+c+d)
										}
										return a
									}
									function e(a,b,c)
									...
									function g(a,b,d)
									{
										for(var e={},Ee={},g=Me().va,Fe=0;Fe<g.length;++Fe)
											...
											Ge(e)&&(b=Qe(e),d?l(b,a):ca(b,a,!1));!d&&Ge(Ee)&&(d=Qe(Ee),ca(d,a,!0))
										}
										function ca(a,b,c)
										{
											b.href&&(a=e(a,b.href,void 0===c?!1:c),ye.test(a)&&(b.href=a))
										}
										function l(a,b)
										{
											if(b&&b.action)
												{
													...
													var k=this,w=function(a,b)
													{
														a=a.split(".");
														var c=k;a[0]in c||"undefined"==typeof c.execScript||c.execScript("var "+a[0]);
														for(var d;a.length&&(d=a.shift());)a.length||void 0===b?c=c[d]&&c[d]!==Object.prototype[d]?c[d]:c[d]={}:c[d]=b},ha=function(a)
															{
																var b=[];
																...
																},Ge=function(a)
																{
																	...
																	return!1
																},ye=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,Ie=window,He=document,Be=function(a,b)
																{
																	He.addEventListener?He.addEventListener(a,b,!1):He.attachEvent&&He.attachEvent("on"+a,b)},Ce=/:[0-9]+$/,xe=function(a,b)
																	{
																		var c=function(a)
																		{
																			...
																			switch(b)
																			{
																				case "protocol":a=c;
																				break;
																				case "host":a=(a.hostname||Ie.location.hostname).replace(Ce,"").toLowerCase();
																				break;
																				case "port":a=String(Number(a.hostname?a.port:Ie.location.port)||("http"==c?80:"https"==c?443:""));
																				break;
																				case "path":a="/"==a.pathname.substr(0,1)?a.pathname:"/"+a.pathname;
																				a=a.split("/");
																				0<=ha(a[a.length-1])&&(a[a.length-1]="");a=a.join("/");
																				break;
																				...
																				a=a.split("/")[0];
																				break;
																				case "fragment":a=a.hash.replace("#","");
																				break;
																				default:a=a&&a.href
																			}
																			return a
																		},da=function(a)
																		{
																			...
																			a&&(ye.test(a),b.href=a);a=b.pathname;"/"!==a[0]&&(a="/"+a);
																		...
																		},te,Ae,ve=function(c)
																		{
																			...
																			for(var d=[],e=0;e<c.length;e+=3)
																				{
																					var g=e+1<c.length,ca=e+2<c.length,Ee=c.charCodeAt(e),l=g?c.charCodeAt(e+1):0,w=ca?c.charCodeAt(e+2):0,k=Ee>>2;
																					Ee=(Ee&3)<<4|l>>4;
																					l=(l&15)<<2|w>>6;
																					w&=63;
																					ca||(w=64,g||(l=64));
																			...
																			},Ke=function(c)
																			{
																				function d(a)
																				{
																					for(;g<c.length;)
																						{
																							var b=c.charAt(g++),d=Ae[b];
																							if(null!=d)
																								return d;
																							if(!/^[\s\xa0]*$/.test(b))
																								throw Error("Unknown base64 encoding at char: "+b);
																						}
																						return a
																					}
																					te=te||b();
																					...
																					for(var e="",g=0;;)
																						{
																							var ca=d(-1),Ee=d(0),l=d(64),w=d(64);
																							if(64===w&&-1===ca)
																								return e;
																					...
																					},Le,Me=function()
																					{
																						...
																						Ie.sa=void 0===b?a:b;
																						a=Ie.sa;
																						(b=a.wa)&&b.va||(b={va:[]},a.wa=b);
																						return b
																					},Nd=/(.*?)\*(.*?)\*(.*)/,we=/([^?#]+)(\?[^#]*)?(#.*)?/,ze=/(.*?)(^|&)_gl=([^&]*)&?(.*)/,Qe=function(a)
																					{
																						var b=[],c;
																						for(c in a)
																							if(a.hasOwnProperty(c))
																								...
																								a=b.join("*");
																								return["1",Ne(a),a].join("*")},Ne=function(a,b)
																								{
																									...
																									if(!(b=Le))
																										{
																											...
																											return((b^-1)>>>0).toString(36)},Oe=function(a)
																											{
																												return function(b)
																												{
																													var c=da(Ie.location.href),d=c.search.replace("?","");
																													a:{for(var e=d.split("&"),g=0;g<e.length;g++)
																													{
																														var ca=e[g].split("=");
																											...
																											},Pe=function(a,b,c)
																											{
																												...
																												Ie.history&&Ie.history.replaceState&&(ze.test(b)||ze.test(c))&&(a=xe(a,"path"),b=e(b,"?"),c=e(c,"#"),Ie.history.replaceState({},void 0,""+a+b+c))
																											},Re=function(a)
																											{
																												var b=void 0===b?3:b;
																												try
																															...
																															},Se=function(a)
																															{
																																try
																																{
																																	...
																																	for(a=100;b&&0<a;)
																																		...
																																		if(c)
																																			{
																																				var d=c.protocol;"http:"!==d&&"https:"!==d||g(c,c.hostname,!1)
																																			}
																																		}
																																		catch(ff){}
																																	},Je=function(a)
																																		...
																																		w("google_tag_data.glBridge.auto",function(a,b,c,d)
																																			{
																																				...
																																				a={za:a,Aa:b,ea:"fragment"===c,forms:!!d
																																			};
																																			Me().va.push(a)});
																																		w("google_tag_data.glBridge.decorate",function(a,b,c)
																																			{
																																				...
																																				if(b.tagName)
																																					{
																																						if("a"==b.tagName.toLowerCase())return ca(a,b,c);
																																	...
																																	var $c=function(a)
																																	{
																																		...
																																		var Td=function(a)
																																		{
																																			...
																																			for(var b=vd.w.slice(),c=0;c<a.w.length;c++)
																																				b[c]=b[c]||a.w[c];
																																			return(new $c(b)).encode()},Dd=function(a)
																																			{
																																				a=a.get(Gd);
																																				ka(a)||(a=[]);
																																				return a
																																											...
																																											for(c=0;c<b.length;c++)
																																												...
																																												var Ca=function(a)
																																												{
																																													...
																																													},zc=function(a,b,c,d,e,g)
																																													{
																																														...
																																														c=a+"="+b+"; path="+c+"; ";g&&(c+="expires="+(new Date((new Date).getTime()+g)).toGMTString()+"; ");
																																														d&&"none"!==d&&(c+="domain="+d+";");d=M.cookie;M.cookie=c;if(!(d=d!=M.cookie))a:{a=Ca(a);
			...
			if(a)
				{
					...
					if(a=!(0<=b.indexOf("Chrome"))&&!(0<=b.indexOf("CriOS"))&&(0<=b.indexOf("Safari/")||0<=b.indexOf("Safari,")))b=Id.exec(b),a=11<=(b?Number(b[1]):-1);oc=a
				}
				else oc=!1
			}
		return oc
	};
	var Fa,Ga,fb,Ab,ja=/^https?:\/\/[^/]*cdn\.ampproject\.org\//,Ue=/^(?:www\.|m\.|amp\.)+/,Ub=[],ic=function(){Z.D([ua])},tc=function(a,b)
	{
		var c=Ca("AMP_TOKEN");
		...
		if(Fa)return Ub.push(a),!0;if("$RETRIEVING"==c)return J(57),va(function(){tc(a,b)},1E4),!0;Fa=!0;c&&"$"!=c[0]||(xc("$RETRIEVING",3E4),setTimeout(Mc,3E4),c="");
...
},xc=function(a,b)
{
	if(void 0===fb)
		...
		var oe=function()
		{
			return(Ba||"https:"==M.location.protocol?"https:":"http:")+"//www.google-analytics.com"},Da=function(a)
			{
				this.name="len";this.message=a+"-8192"},ba=function(a,b,c)
				{
					c=c||ua;if(2036>=b.length)wc(a,b,c);
			...
			{
				var d=ta(a+"?"+b);d.onload=d.onerror=function()
				{
...
g.onreadystatechange=function()
{
	if(4==g.readyState)
		...
		{
			1<=100*Math.random()||G("?")||(a=["t=error","_e="+a,"_v=j71","sr=1"],b&&a.push("_f="+b),c&&a.push("_m="+K(c.substring(0,100))),a.push("aip=1"),a.push("z="+hd()),wc("https://www.google-analytics.com/u/d",a.join("&"),ua))
		};
		var h=function(a)
		{
...
function Sa(a)
{
	var b=P(a,gd)||oe()+"/collect",c=a.get(qe),d=P(a,fa);!d&&a.get(Vd)&&(d="beacon");
	if(c)pe(b,P(a,Ra),c,a.get(Ia));
	else if(d)
		{
			...
			d=P(a,Ra);
			var e=a.get(Ia);
			e=e||ua;"image"==c?wc(b,d,e):"xhr"==c&&wd(b,d,e)||"beacon"==c&&x(b,d,e)||ba(b,d,e)
		}
		else ba(b,P(a,Ra),a.get(Ia));b=a.get(Na);b=h(b);
		c=b.hitcount;
		b.hitcount=c?c+1:1;b=a.get(Na);
...
function Ta(a)
{
	...
	Ya.prototype.get=function(a)
	{
		...
		return b&&b.Z?b.Z(this,a,c):c};var P=function(a,b)
		{
			a=a.get(b);
			return void 0==a?"":""+a
		},R=function(a,b)
	...
	},$a=function(a)
	{
		...
		if(!b)
			for(var c=0;c<Za.length;c++)
				...
				var gb=qa(window.GoogleAnalyticsObject)&&sa(window.GoogleAnalyticsObject)||"ga",jd=/^(?:utma\.)?\d+\.\d+$/,kd=/^amp-[\w.-]{22,64}$/,Ba=!1,hb=T("apiVersion","v"),ib=T("clientVersion","_v");
				S("anonymizeIp","aip");
...
cb("\\&(.*)",function(a)
	{
		...
		c&&(b.Z=function(a)
			{
				return a.get(c)},b.o=function(a,b,g,ca)
				{
					a.set(c,g,ca)
				},b.F=void 0);
		return b
...
function fc()
{
	...
	if((b=(b=O.navigator)?b.plugins:null)&&b.length)
		for(var c=0;c<b.length&&!a;c++)
			...
			a&&(e=a.match(/[\d]+/g))&&3<=e.length&&(a=e[0]+"."+e[1]+" r"+e[2]);return a||void 0
		};
		var aa=function(a)
		{
		...
		},gc=function(a)
		{
			...
			if(Ec(b)||Fc(b))
				{
					var c=b[Eb];
					void 0==c||Infinity==c||isNaN(c)||(0<c?(Y(b,Gb),Y(b,Jb),Y(b,Ib),Y(b,Fb),Y(b,Hb),Y(b,Kb),Y(b,Lb),Y(b,Ve),Y(b,We),Y(b,Xe),Y(b,Ye),va(function(){a(b)},10)):L(O,"load",function(){gc(a)},!1))}},Ec=function(a)
					{
							...
							if(c)
								{
									...
									a.data.set(he,d);
									b={};
									var e=a.get(fe),g=a.get(ie),ca=kc(P(a,Yb)),l=lc(P(a,W));
									a=P(a,Na);
...
function Xc(a,b,c)
{
	...
	function Zc(a,b)
	{
		...
		var od=new RegExp(/^https?:\/\/([^\/:]+)/),De=O.google_tag_data.glBridge,pd=/(.*)([?&#])(?:_ga=[^&#]*)(?:&?)(.*)/,me=/(.*)([?&#])(?:_gac=[^&#]*)(?:&?)(.*)/;
		function Bc(a)
		{
			if(a.get(Ze))
...
function Ic(a,b)
{
	var c=new Date,d=O.navigator,e=d.plugins||[];a=[a,d.userAgent,c.getTimezoneOffset(),c.getYear(),c.getDate(),c.getHours(),c.getMinutes()+b];
...
function pa(a,b)
{
	var c=new Date,d=O.navigator,e=c.getHours()+Math.floor((c.getMinutes()+b)/60);return La([a,d.userAgent,d.language||"",c.getTimezoneOffset(),c.getYear(),c.getDate()+Math.floor(e/24),(24+e)%24,(60+c.getMinutes()+b)%60].join("."))}
var Dc=function(a)
{
	J(48);
	this.target=a;
...
Dc.prototype.S=function(a,b,c)
{
	function d(c)
	{
		try{c=c||O.event;a:{var d=c.target||c.srcElement;for(c=100;d&&0<c;)
			{
				...
				e={}}("http:"==e.protocol||"https:"==e.protocol)&&sd(a,e.hostname||"")&&e.href&&(e.href=qd(g,e.href,b))
			}
			catch(w)
			{
				J(26)
		...
		if(this.target.get(Ze))De.auto(function()
			{
				...
				{
					var g=this;
					this.T||(this.T=!0,L(M,"mousedown",d,!1),L(M,"keyup",d,!1));c&&L(M,"submit",function(b)
						{
							b=b||O.event;
			...
			function sd(a,b)
			{
				...
				for(var c=0;c<a.length;c++)
					...
					function $e(a)
					{
						...
						{
							_ga:a.get(Q),_gid:a.get(I)||void 0,_gac:b?[b.qa,b.timestamp].join("."):void 0}
						}
...
function af(a)
{
	...
	var p=/^(GTM|OPT)-[A-Z0-9]+$/,q=/;
	_gaexp=[^;]*/g,r=/;
	((__utma=)|([^;=]+=GAX?\d+\.))[^;]*/g,Aa=/^https?:\/\/[\w\-.]+\.google.com(:\d+)?\/optimize\/opt-launch\.html\?.*$/,t=function(a)
	{
		function b(a,b)
		{
			b&&(c+="&"+a+"="+K(b))
		}
		var c="https://www.google-analytics.com/gtm/js?id="+K(a.id);"dataLayer"!=a.B&&b("l",a.B);b("t",a.target);
		b("cid",a.clientId);
		b("cidt",a.ka);
		b("gac",a.la);
		b("aip",a.ia);
		a.sync&&b("m","sync");
		b("cycle",a.G);a.qa&&b("gclid",a.qa);
						...
						if(!ad)
							{
								...
								var e=O.name,g=/^#?gaso=([^&]*)/;
								if(e=(d=(d=d&&d.match(g)||e&&e.match(g))?d[1]:Ca("GASO")[0]||"")&&d.match(/^(?:!([-0-9a-z.]{1,40})!)?([-.\w]{10,1200})$/i))zc("GASO",""+d,c,b,a,0),window._udo||(window._udo=b),window._utcp||(window._utcp=c),a=e[1],wa("https://www.google.com/analytics/web/inpage/pub/inpage.js?"+(a?"prefix="+a+"&":"")+hd(),"_gasojs");ad=!0
							}
						};
									...
									if(!c)
										...
										c&&(hc=!0);
											if(d=c&&!a.get(Hd))
												...
												if(a.get(je)&&(c=a.get(ce),d=a.get(ie),!c||d&&"aw.ds"!=d)){c={};
												if(M){d=[];
													e=M.cookie.split(";");
													for(var g=/^\s*_gac_(UA-\d+-\d+)=\s*(.+?)\s*$/,ca=0;ca<e.length;ca++)
														{
															var l=e[ca].match(g);
															l&&d.push({ja:l[1],value:l[2]})}e={};
															if(d&&d.length)
...
else
	{
		...
		if("1"==e)
			{
				...
				else if("2"==e){d=g.indexOf("-");
				e="";0<d?(e=g.substring(0,d),d=g.substring(d+1)):d=g.substring(1);
				if(ke(e+d,c))
					{
						J(53);
						break b
		...
		b&&(J(9),a.data.set(Q,K(b)));a.get(Q)||((b=(b=O.gaGlobal&&O.gaGlobal.vid)&&-1!=b.search(jd)?b:void 0)?(J(17),a.data.set(Q,b)):(J(8),a.data.set(Q,ra())));
	...
	},Kc=function(a)
	{
		...
		if(d)
			{
				var e=d.pathname||"";"/"!=e.charAt(0)&&(J(31),e="/"+e);
			...
			if(d&&a.get(cc)&&(b=M.location.hash))
				{
					...
					0<d.length&&(b="#"+d.join("&"),a.set(kb,a.get(kb)+b))}};pc.prototype.get=function(a)
					{
						return this.b.get(a)
					};
...
pc.prototype.send=function(a)
{
	if(!(1>arguments.length))
		...
		{
			var c=this;u(a,c,b)||(v(a,function()
				{
					u(a,c,b)
		...
		if(!ea(Yd.get(b))&&!$d.get(b))
			{
				...
				if(p.test(b))
					...
					a=d.B;c=(new Date).getTime();O[a]=O[a]||[];c={"gtm.start":c};e||(c.event="gtm.js");O[a].push(c);c=t(d)}!c&&Zd.hasOwnProperty(b)?(J(39),c=b+".js"):J(43);
...
("https:"==a||a==c||("http:"!=a?0:"http:"==c))&&B(d)&&(wa(d.url,void 0,e),$d.set(b,!0)))
			...
			{
				var c=A.get(a)||[];c.push(b);A.set(a,c)},C=function(a,b)
				{
				...
				},B=function(a)
				{
					...
					return"www.google-analytics.com"==a.host&&(a.port||b)==b&&D(a.path,"/plugins/")?!0:!1},ae=function(a)
					{
						function b(a)
						{
...
Z.v=function(a){try{if(a.u)a.u.call(O,N.j("t0"));else{var b=a.c==gb?N:N.j(a.c);if(a.A)
	{
	...
	if(a.i)
		{
			if(a.ha&&(a.ha=y(a.c,a.a[0],a.X,a.W)),!u(a.a[0],b,a.W))return!0}else if(a.K)
				{
	...
	if(!a||42!=a.answer)
		{
			...
			if("https:"!=M.location.protocol&&!Ba)
				{
					a:{b=M.getElementsByTagName("script");
